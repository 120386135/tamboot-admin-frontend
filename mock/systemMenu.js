...
const proxy = {
  'GET /api/system/menu/tree': (req, res) => {
    res.json({
  ...
  'GET /api/system/menu/roleMenus': (req, res) => {
    res.json({
      code: Constants.BusinessCode.SUCCESS,
      msg: 'success',
      data: ['6533916193823133696', '6533916677858398211', '6533917218659373061', '6533917345537069062']
    })
  },

  'POST /api/system/menu/update': (req, res) => {
    res.json({
      code: Constants.BusinessCode.SUCCESS,
      msg: 'success'
    })
  ...
  'POST /api/system/menu/create': (req, res) => {
    res.json({
      code: Constants.BusinessCode.SUCCESS,
      msg: 'success'
    })
  ...
  'POST /api/system/menu/delete/:id': (req, res) => {
    res.json({
      code: Constants.BusinessCode.SUCCESS,
      msg: 'success'
    })
